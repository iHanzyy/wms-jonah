        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-orange-400 font-bold text-xl">
                        Clevio Pro
                    </a>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="bg-gray-700 text-gray-300">
                            <x-dropdown-link :href="route('profile.edit')" class="text-gray-300 hover:bg-gray-600">
                                {{ __('Profile') }}
                            </x-dropdown-link>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                        ...
                                        class="text-gray-300 hover:bg-gray-600">
                                    {{ __('Log Out') }}
                                </x-dropdown-link>
                            </form>
                        </div>
